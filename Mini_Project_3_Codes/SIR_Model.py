...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 09:11:35 2024
...
L_norm = np.sqrt(dYdt(SS, II)[0]**2 + dYdt(SS, II)[1]**2)

# Plot the phase portrait using quiver:
plt.figure(2)
plt.quiver(SS, II, dYdt(SS, II)[0] / L_norm, dYdt(SS, II)[1] / L_norm, color=[.75, .75, .75], scale=25)
